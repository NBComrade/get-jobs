 ...
 */
class Version20180316084207 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE search_settings (id INTEGER NOT NULL, domain VARCHAR(255) NOT NULL, pattern VARCHAR(255) NOT NULL, cart VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, link VARCHAR(255) NOT NULL, company VARCHAR(255) NOT NULL, next VARCHAR(255) NOT NULL, date VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
